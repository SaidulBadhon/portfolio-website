...
**Jutsu IDE** bridges the gap between traditional development tools and the decentralized web, providing developers with a familiar yet powerful environment for building the future of the internet.`,
  ...
  {
    slug: "postt-ai",
    title: "Postt.ai - AI Content Platform",
    label: "Postt.ai - The Content Platform That Writes Like You",
    shortDescription:
      "AI-powered content platform that learns your unique voice and creates on-brand posts, carousels, and videos for busy founders.",
    description: `# Postt.ai: The Content Platform That Writes Like You

## Overview
**Postt.ai** is a revolutionary AI-powered content platform designed specifically for busy founders who want on-brand content that sounds like them without writing it themselves. The platform learns your unique voice and tone to create authentic, personalized content across multiple formats.

## Key Features

### 1. **Personalized Voice Learning**
- **Tone Analysis**: Upload a few posts or notes, and Postt learns your tone in minutes
- **Authentic Content**: Every post sounds like you, without needing to write it yourself
- **Brand Consistency**: Maintains your unique voice across all content

### 2. **Multi-Format Content Campaigns**
- **Full Week Planning**: Turns one idea into a full content campaign
- **Multiple Formats**: Creates posts, carousels, and videos mapped out for the week
- **Efficient Workflow**: Helps you stay visible with less effort

### 3. **Built-in Research & Ideation**
- **Web Search Integration**: Pulls in fresh ideas, headlines, stats, and trending topics
- **Content Discovery**: No more wasting time researching what to post
- **Real-time Insights**: Brings relevant information directly into the editor

### 4. **Campaign Management**
- **Multi-format Campaigns**: Your ideas become multi-format campaigns in minutes
- **Consistency Tools**: Maintain posting consistency without manual planning
- **Social Media Integration**: Manage up to unlimited social accounts (depending on plan)
...
### Alexander Pena - Business Owner
Saw a **26,000% increase in impressions** in just 7 days after switching to Postt. "Postt feels like having a co-founder for content. It actually sounds like me and I don't have to block out hours every week just to stay visible."

### Cameron Dennis - NEAR Protocol
"We tried ghostwriters. We tried templates. Nothing worked. Postt helped us build a voice that actually matched our brand."

### Jenny Moore
"Used to feel invisible on LinkedIn. Now her content starts real conversations and gets seen by thousands."

## Technical Implementation

Built with cutting-edge AI technology, Next.js for the frontend, and integrated with major AI providers including Claude (Anthropic), AWS, OpenAI, and Fal for advanced content generation and processing.

## Impact

Postt.ai has helped over 1,000 founders maintain consistent, on-brand social media presence without the time investment typically required. The platform demonstrates measurable results with users seeing dramatic increases in engagement and visibility.`,
    tags: [
      "AI",
      "Next.js",
      "TypeScript",
    ...
    projectDuration: "6",
    projectTeam: "3",
    projectRole: "Full-Stack Developer & Founder",
    projectResponsibilities: [
      "Built the entire platform from scratch using Next.js, React, and TypeScript.",
      "Integrated multiple AI providers (Claude, OpenAI, AWS, Fal) for content generation.",
      "Developed the voice learning algorithm that analyzes user writing patterns.",
      "Implemented multi-format content campaign system (posts, carousels, videos).",
      "Created the web search integration for real-time content ideation.",
      "Built the subscription and pricing system with Stripe integration.",
      "Designed and implemented the user dashboard and content editor.",
